								   ...
								   uint16_t mechanical_angle_u16)
{
	...
	/* electrical_angle_u16 = mechanical_angle_u16 * pole_pairs + electrical_offset_u16. */
	uint32_t electrical_angle_u32 =
	...
	motor_h->measurements.electrical_angle_u16 = (uint16_t)electrical_angle_u32;
